...
X.parserIMG.prototype.parse = function(container, object, hdrdata, data, flag) {
	...
	if (sizeof_hdr != 348) {
		...
		window.console.log("big endian");
	} else {
		window.console.log("little endian");
	}
	...
	object._spacing = _spacing;
		...
		window.console.log("dimensions " + MRI.dim[1] + " " + MRI.dim[2]+ " " +MRI.dim[3]);
		window.console.log("spacing " + MRI.pixdim[1]+ " " +MRI.pixdim[2]+ " " +MRI.pixdim[3]);
