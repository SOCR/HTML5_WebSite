	...
	/*	dummyTotal = new double[sampleSize][numberColumns];
		...
		//	System.out.println("rssErrorInteraction="+ rssErrorInteraction);
         ...
         //	two way, count=2    group[2] value are for i:j interaction
			...
			/// Oct 10, 2014, Bug Fix
			//// Example 2 in 2-way ANOVA ////////////////////////////////////////////////////////////////
			// VarianceSource 	 DF 	 RSS 	 MSS 	 F-Statistics 	 P-value
			// MainEffect:I		2	107.57625	53.78812	25.98373	 .00000
			// MainEffect:J		3	104.52062	34.84021	16.83045	 .00000
			// Interaction I:J	6	30.53875	5.08979	 	26.00238 !!!! Wrong; should be 2.458753!!!
			// Error		36	74.52250	2.07007
			// Total:		47	317.15812
			estVarModel = mseModelGroup[2];
			// OLD: estVarModel = rssModel / dfModel;
			// Fixed a problem with computing the F-statistics (and P-value) of the Interaction term!!!
			estVarError = rssError/ dfError;
			//System.out.println("mseModelGroup[2]="+mseModelGroup[2]+"\t dfModelGroup[2] ="+dfModelGroup[2]+
			//		"\n rssError="+rssError+"\t dfError="+dfError+"\n");			
