...
public class FisherExactCSV {
	...
	public static void main(String[] args) {
		...
		// OLD: ArrayList<String>[] xList = new ArrayList<String> [rowNumber];
		// NEW template: ArrayList<String>[] xList = (ArrayList<String>[]) new ArrayList[1];
		ArrayList<String>[] xList = (ArrayList<String>[]) new ArrayList[rowNumber];
